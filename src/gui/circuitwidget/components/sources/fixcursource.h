...
#ifndef FIXCURSOURCE_H
#define FIXCURSOURCE_H
...
class MAINMODULE_EXPORT FixCurSource : public Component, public eElement
{
    Q_OBJECT
    ...
    public:
        ...
        FixCurSource( QObject* parent, QString type, QString id );
        ~FixCurSource();
